...
const Footer = () => {
  const { logo, address, email, list1, list2, list3, socialList } = footerData;
  return (
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row text-center xl:text-left gap-y-12">
          ...
          <div className="flex flex-1 flex-col gap-y-14 xl:flex-row justify-between">
            {/* list 1 */}
            <div>
              <div className="font-extrabold text-primary mb-8">Developers</div>
            ...
            {/* list 2 */}
            <div>
              <div className="font-extrabold text-primary mb-8">Discover</div>
              <ul className="flex flex-col gap-y-4">
            ...
            {/* list 3 */}
            <div>
              <div className="font-extrabold text-primary mb-8">Community</div>
              <ul className="flex flex-col gap-y-4">
